          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _NavItem(icon: Icons.payments_outlined, selectedIcon: Icons.payments, label: 'Paiements', path: '/payments', index: 3),
                _NavItem(icon: Icons.receipt_long_outlined, selectedIcon: Icons.receipt_long, label: 'Dépenses', path: '/expenses', index: 4),
                _NavItem(icon: Icons.bar_chart_outlined, selectedIcon: Icons.bar_chart, label: 'État de l\'activité', path: '/activity-report', index: 5),
                _NavItem(icon: Icons.settings_outlined, selectedIcon: Icons.settings, label: 'Paramètres', path: '/settings', index: 6),
              ],
            ),
          ),
          const Divider(),
