...
-- ============================================================
-- ADDITIONS: CUMP + historique_prix_achat + triggers Neon
-- A appliquer apres migration.sql sur Neon PostgreSQL
-- ============================================================

-- ============================================================
-- SECTION 1: Colonne cump + table historique_prix_achat
-- ============================================================
...
-- Initialiser cump = prix_achat pour les produits existants
UPDATE "produits" SET "cump" = "prix_achat"
WHERE "prix_achat" IS NOT NULL AND "prix_achat" > 0 AND "cump" IS NULL;

-- Initialiser l'historique depuis les prix d'achat existants
INSERT INTO "historique_prix_achat" ("produit_id", "prix_achat", "quantite", "source")
SELECT "id", "prix_achat", 1, 'manuel'
FROM "produits"
WHERE "prix_achat" IS NOT NULL AND "prix_achat" > 0
ON CONFLICT DO NOTHING;

-- ============================================================
-- SECTION 2: Fonction trigger update_date_modification
-- ============================================================
...
-- ============================================================
-- SECTION 3: Triggers sur tables avec date_modification native
-- ============================================================
...
CREATE TRIGGER update_utilisateurs_date_modification
    BEFORE UPDATE ON utilisateurs FOR EACH ROW EXECUTE FUNCTION update_date_modification();

DROP TRIGGER IF EXISTS update_boutiques_date_modification ON boutiques;
CREATE TRIGGER update_boutiques_date_modification
    BEFORE UPDATE ON boutiques FOR EACH ROW EXECUTE FUNCTION update_date_modification();
...
CREATE TRIGGER update_categories_date_modification
    BEFORE UPDATE ON categories FOR EACH ROW EXECUTE FUNCTION update_date_modification();

DROP TRIGGER IF EXISTS update_produits_date_modification ON produits;
CREATE TRIGGER update_produits_date_modification
    BEFORE UPDATE ON produits FOR EACH ROW EXECUTE FUNCTION update_date_modification();
...
CREATE TRIGGER update_fournisseurs_date_modification
    BEFORE UPDATE ON fournisseurs FOR EACH ROW EXECUTE FUNCTION update_date_modification();
...
CREATE TRIGGER update_movement_categories_date_modification
    BEFORE UPDATE ON movement_categories FOR EACH ROW EXECUTE FUNCTION update_date_modification();
...
CREATE TRIGGER update_ventes_proforma_date_modification
    BEFORE UPDATE ON ventes_proforma FOR EACH ROW EXECUTE FUNCTION update_date_modification();
...
CREATE TRIGGER update_user_roles_date_modification
    BEFORE UPDATE ON user_roles FOR EACH ROW EXECUTE FUNCTION update_date_modification();
...
CREATE TRIGGER update_cash_registers_date_modification
    BEFORE UPDATE ON cash_registers FOR EACH ROW EXECUTE FUNCTION update_date_modification();
...
CREATE TRIGGER update_parametres_entreprise_date_modification
    BEFORE UPDATE ON parametres_entreprise FOR EACH ROW EXECUTE FUNCTION update_date_modification();

-- ============================================================
-- SECTION 4: Ajout date_modification + triggers tables transactionnelles
-- ============================================================
...
CREATE TRIGGER update_financial_movements_date_modification
    BEFORE UPDATE ON financial_movements FOR EACH ROW EXECUTE FUNCTION update_date_modification();
...
CREATE TRIGGER update_reimpressions_recus_date_modification
    BEFORE UPDATE ON reimpressions_recus FOR EACH ROW EXECUTE FUNCTION update_date_modification();
...
CREATE TRIGGER update_movement_attachments_date_modification
    BEFORE UPDATE ON movement_attachments FOR EACH ROW EXECUTE FUNCTION update_date_modification();

-- ============================================================
-- SECTION 5: Tables de comptes
-- ============================================================
...
CREATE TRIGGER update_dates_peremption_date_modification
    BEFORE UPDATE ON dates_peremption FOR EACH ROW EXECUTE FUNCTION update_date_modification();

-- ============================================================
-- SECTION 7: Tables d'assignation
-- ============================================================
