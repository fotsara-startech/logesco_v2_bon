...
class StockInventory {
  ...
  factory StockInventory.fromJson(Map<String, dynamic> json) {
    return StockInventory(
      ...
      dateDebut: json['dateDebut'] != null ? DateTime.parse(json['dateDebut']).toLocal() : null,
      dateFin: json['dateFin'] != null ? DateTime.parse(json['dateFin']).toLocal() : null,
...
class InventoryItem {
  ...
  factory InventoryItem.fromJson(Map<String, dynamic> json) {
    return InventoryItem(
      ...
      dateComptage: json['dateComptage'] != null ? DateTime.parse(json['dateComptage']).toLocal() : null,
