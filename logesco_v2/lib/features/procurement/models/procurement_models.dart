...
class CommandeApprovisionnement {
  ...
  factory CommandeApprovisionnement.fromJson(Map<String, dynamic> json) {
    return CommandeApprovisionnement(
      ...
      dateCommande: DateTime.parse(json['dateCommande'] ?? DateTime.now().toIso8601String()).toLocal(),
      dateLivraisonPrevue: json['dateLivraisonPrevue'] != null ? DateTime.parse(json['dateLivraisonPrevue']).toLocal() : null,
