      ...
      if (cachedData != null && cacheTimestamp != null) {
        ...
        if (now.difference(cacheTime) < _cacheExpiration) {
          ...
          return CompanyProfile(
            ...
            createdAt: jsonData['dateCreation'] != null ? DateTime.parse(jsonData['dateCreation']).toLocal() : DateTime.now(),
            updatedAt: jsonData['dateModification'] != null ? DateTime.parse(jsonData['dateModification']).toLocal() : DateTime.now(),
