...
/// Widget de carte pour afficher un compte fournisseur
class CompteFournisseurCard extends StatelessWidget {
  final CompteFournisseur compte;
  final VoidCallback? onTap;

  const CompteFournisseurCard({
    super.key,
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // En-tête avec nom du fournisseur et statut
              Row(
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          compte.fournisseur.nom,
                          style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                          ),
                        ),
                        if (compte.fournisseur.personneContact != null)
                          Text(
                            'Contact: ${compte.fournisseur.personneContact}',
                            style: TextStyle(
                              fontSize: 14,
                              color: Colors.grey[600],
                            ),
                          ),
                        if (compte.fournisseur.telephone != null)
                          Text(
                            compte.fournisseur.telephone!,
                            style: TextStyle(
                              fontSize: 14,
                              color: Colors.grey[600],
                            ),
