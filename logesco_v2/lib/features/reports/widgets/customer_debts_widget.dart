          ...
          children: [
            Row(
              children: [
                ...
                Text('reports_debts_title'.tr, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              ],
            ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(child: _buildDebtItem('reports_debts_total'.tr, debtsData.totalOutstandingDebtFormatted, Icons.account_balance, Colors.red.shade600)),
                  Container(width: 1, height: 50, color: Colors.orange.shade200),
                  Expanded(child: _buildDebtItem('reports_debts_customers_count'.tr, debtsData.customersWithDebt.toString(), Icons.person, Colors.orange.shade600)),
                  Container(width: 1, height: 50, color: Colors.orange.shade200),
                  Expanded(child: _buildDebtItem('reports_debts_average'.tr, debtsData.averageDebtPerCustomerFormatted, Icons.trending_up, Colors.blue.shade600)),
                ],
              ),
            ),
            if (debtsData.topDebtors.isNotEmpty) ...[
              const SizedBox(height: 20),
              Text('reports_debts_top_debtors'.tr, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text('reports_debts_days_overdue'.trParams({'days': debt.daysOverdue.toString()}), style: TextStyle(fontSize: 12, color: Colors.grey.shade600)),
                          ],
                        ),
                      ],
                    ),
